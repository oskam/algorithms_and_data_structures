...
public class Plots extends ApplicationFrame {
    ...
    private CategoryDataset createDataset() {
        ...
        for (String dataname : plotdata.keySet()) {
            ...
            final String linear = "n";
            final String quadratic = "n^2";
            final String logarithmic = "log(n)";
            final String linearithmic = "n*log(n)";
...
//                dataset.addValue(sizeFloat, linear, size);
//                dataset.addValue((Math.pow(sizeFloat, 2.0)), quadratic, size);
                dataset.addValue(1.9*Math.log(sizeFloat), logarithmic, size);
//                dataset.addValue(Math.log(sizeFloat)*sizeFloat, linearithmic, size);
            }
        }
        return dataset;
    ...
    public static void main(final String[] args) {
        final Plots demo = new Plots("Binary Search Tree", args);
        demo.pack();
